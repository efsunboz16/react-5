    ...
    <div className="min-h-screen bg-black/80 ">
     ...
     <div>
      <div className="flex flex-col items-center justify-center  gap-3 h-max mt-45">
        ...
        <Link to="/app"><button className="bg-white text-black font-bold py-2 px-4 rounded mt-5 hover:bg-black hover:text-white hover:border-black cursor-pointer">Get Started</button></Link>
      </div>
    </div>
  </div>
